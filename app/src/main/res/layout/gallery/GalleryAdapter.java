...
public class GalleryAdapter extends RecyclerView.Adapter<com.yarolegovich.discretescrollview.sample.gallery.GalleryAdapter.ViewHolder> {

    private int itemHeight;
    private List<com.yarolegovich.discretescrollview.sample.gallery.Image> data;

    public GalleryAdapter(List<com.yarolegovich.discretescrollview.sample.gallery.Image> data) {
        this.data = data;
    }
